...
public class thirdATM extends JFrame implements ActionListener{
	JFrame frame;
	...
	thirdATM(){
		...
		showName = new JLabel("Sven Blacksmith");
		...
		showBalance = new JLabel("Balance: PHP " + Login.thirdbalance);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()== wiDrawENTButton) {
			...
			Login ATM = new Login();
			ATM.thirdbalance = ATM.thirdbalance - withdrawMoney;
			frame.dispose();
		}
		/////
		...
		if(e.getSource() == dpostENTButton) {
			...
			Login ATM = new Login();
			ATM.thirdbalance = ATM.thirdbalance + depositMoney;
			frame.dispose();
		}
		/////
		...
		if(e.getSource() == chgENTButton) {
			...
			Login.thirdPIN = newPIN;
			frame.dispose();
		}
		/////
		if(e.getSource()==refreshButton) {
			thirdATM refresh = new thirdATM();
			frame.dispose();
		}
		/////
