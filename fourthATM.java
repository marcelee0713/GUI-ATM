...
public class fourthATM extends JFrame implements ActionListener{
	JFrame frame;
	...
	fourthATM(){
		...
		showName = new JLabel("Kyle Ashner");
		...
		showBalance = new JLabel("Balance: PHP " + Login.fourthbalance);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()== wiDrawENTButton) {
			...
			Login ATM = new Login();
			ATM.fourthbalance = ATM.fourthbalance - withdrawMoney;
			frame.dispose();
		}
		/////
		...
		if(e.getSource() == dpostENTButton) {
			...
			Login ATM = new Login();
			ATM.fourthbalance = ATM.fourthbalance + depositMoney;
			frame.dispose();
		}
		/////
		...
		if(e.getSource() == chgENTButton) {
			...
			Login.fourthPIN = newPIN;
			frame.dispose();
		}
		/////
		if(e.getSource()== refreshButton) {
			fourthATM refresh = new fourthATM();
			frame.dispose();
		}
		/////
