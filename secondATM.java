...
public class secondATM extends JFrame implements ActionListener{
	JFrame frame;
	...
	secondATM(){
		...
		showName = new JLabel("Henrik Ahnberg");
		...
		showBalance = new JLabel("Balance: PHP " + Login.secondbalance);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()== wiDrawENTButton) {
			...
			Login ATM = new Login();
			ATM.secondbalance = ATM.secondbalance - withdrawMoney;
			frame.dispose();
		}
		/////
		...
		if(e.getSource() == dpostENTButton) {
			...
			Login ATM = new Login();
			ATM.secondbalance = ATM.secondbalance + depositMoney;
			frame.dispose();
		}
		/////
		...
		if(e.getSource() == chgENTButton) {
			...
			Login.secondPIN = newPIN;
			frame.dispose();
		}
		/////
		if(e.getSource()==refreshButton) {
			secondATM refresh = new secondATM();
			frame.dispose();
		}
		/////
