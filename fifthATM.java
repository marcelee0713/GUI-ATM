...
public class fifthATM extends JFrame implements ActionListener{
	JFrame frame;
	...
	fifthATM(){
		...
		showName = new JLabel("Precious Aylar");
		...
		showBalance = new JLabel("Balance: PHP " + Login.fifthbalance);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()== wiDrawENTButton) {
			...
			Login ATM = new Login();
			ATM.fifthbalance = ATM.fifthbalance - withdrawMoney;
			frame.dispose();
		}
		/////
		...
		if(e.getSource() == dpostENTButton) {
			...
			Login ATM = new Login();
			ATM.fifthbalance = ATM.fifthbalance + depositMoney;
			frame.dispose();
		}
		/////
		...
		if(e.getSource() == chgENTButton) {
			...
			Login.fifthPIN = newPIN;
			frame.dispose();
		}
		/////
		if(e.getSource()== refreshButton) {
			fifthATM refresh = new fifthATM();
			frame.dispose();
		}
		/////
